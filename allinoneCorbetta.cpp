...
public:
	//contructor se define inline  debido a que en esta clase no asigna nada
...
Auto1::Auto1(int vel, int x0, int y0): Auto(vel, x0, y0){
	...
	//define el color de las lineas de dibujo del auto 1 x azar
...
Auto2::Auto2(int vel, int x0, int y0): Auto(vel,x0,y0){
	...
	//arma el dibujo de las lineas del auto con el color verde por defecto
...
Auto3::Auto3(int vel, int x0, int y0): Auto(vel, x0,y0){
	...
	//define el color de las lineas de dibujo del auto 3 x azar
	matriz[1][0]=0;  color[1][0] = colorAuto;
	matriz[1][2]=47; color[1][2] = colorAuto;
	matriz[2][0]=30; color[2][0] = colorAuto;
	matriz[2][2]=0;  color[2][2] = colorAuto;
